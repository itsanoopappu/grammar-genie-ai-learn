...
const PlacementTest = () => {
  ...
  const renderQuestion = () => {
    ...
    return (
      <div className="space-y-6">
        {/* Question Header with Grammar Information */}
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            ...
            {currentQuestion.grammar_topic && (
              <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">
                Grammar: {currentQuestion.grammar_topic}
              </Badge>
            )}
            {currentQuestion.grammar_category && (
              <Badge variant="outline" className="bg-purple-50 text-purple-700 border-purple-200">
                Category: {currentQuestion.grammar_category}
              </Badge>
            )}
            ...
            {currentQuestion.subject_category && (
              <Badge variant="outline" className="bg-teal-50 text-teal-700 border-teal-200">
                Context: {currentQuestion.subject_category}
              </Badge>
            )}
          </div>
  ...
  const renderResults = () => {
    if (!state.testCompleted || !state.testResults) return null;
